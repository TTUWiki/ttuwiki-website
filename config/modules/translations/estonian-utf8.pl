# UTF-8 encoded Estonian translation file for use with Oddmuse
#
# Copyright (C) 2015  Ain Laidoja <ain.laidoja@ttu.ee>
#
...
AddModuleDescription('estonian-utf8.pl', 'Estonian') if defined &AddModuleDescription;
...
Vale kasutajanimi %s: Salvestamine ebaõnnestus
UserName must be 50 characters or less: not saved
Kasutajanimi peab olema vähem kui 50 tähemärki: Salvestamine ebaõnnestus
...
Puudub lehekülje nimi
Page name is too long: %s
Lehekülje nimi on liiga pikk: %s
...
Kommentaare pole, ole esimene kommenteerija!
Welcome!
Tere tulemast!
This page does not exist, but you can %s.
Seda lehte pole veel, kuid Sa saad %s
create it now

Too many redirections
Liiga palju kitsendusi
...
Uuendused viimase %s päeva jooksul
...
List all changes
Nimekiri kõigist muudatustest
Skip rollbacks

Include rollbacks

List only major changes
Nimekiri põhimuudatustest
...
Märgi see lehekülg kustutamiseks
...
Failide üleslaadimine lubatud vaid administraatorile
...
Regulaaravaldis "%1" ühildus "%2" käesoleval lehel.
Regular expression "%s" matched on this page.
Regulaaravaldis "%s" ühildus käesoleval lehel.
################################################################################
...
GD või Image::Magick moodulid puuduvad.
GD::SecurityImage module not available.
GD::SecurityImage moodulid puuduvad.
Image storing failed. (%s)
Pildi salvestamine ebaõnnestus (%s)
Bad gd_security_image_id.

Please type the six characters from the anti-spam image
Palun kirjuta kuus tähemärki anti-spämm pildilt
Submit

CAPTCHA

You did not answer correctly.
Su vastus pole korrektne.
...
Lubatud ainult administraatoritele
################################################################################
# modules/index.pl
################################################################################
Index
...
Kasutajanimi %s on juba kasutusel
...
Logi sisse kasutades kasutajanime ja salasõna
...
Sinu salasõna on nüüd muudetud
Forgot Password
Salasõna ununenud
...
Kasutajanimi ja/või salasõna on vale
Logged in as %s.
Logitud sisse kui %s.
Logout of %s
...
Juba parem. Uuenda mooduleid nüüd!
################################################################################
...
Muudetud HTML koodiga leheküljed
Preview changes in HTML output
HTML koodi muudatuste eelvaade
################################################################################
